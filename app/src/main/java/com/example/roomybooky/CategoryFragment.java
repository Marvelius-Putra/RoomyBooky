    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_class.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int flag = 1; // set the flag value
                Intent i = new Intent(getActivity(), FormActivity.class); // use getActivity() to get the context of the activity
                i.putExtra("flag", flag); // pass the flag value to the new activity
                startActivity(i);
            }
        });
        return rootView;
